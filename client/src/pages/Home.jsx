...
const Home = () => {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
                    {[
                        ...
                        <div key={index} className="relative text-center">
                            <div className="inline-flex items-center justify-center w-14 sm:w-16 h-14 sm:h-16 rounded-full bg-linear-to-br from-[#3B7DC3] to-[#4CAF50] text-white text-lg sm:text-[20px] font-bold mb-4 sm:mb-6 shadow-lg">
                                {step.step}
                            </div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">
                                {step.title}
                            ...
                            {index < 2 && (
                                <div className="hidden lg:block absolute top-7 sm:top-8 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-0.5 bg-linear-to-r from-[#3B7DC3]/30 to-[#4CAF50]/30"></div>
                            )}
                        </div>
                    ))}
                </div>
            ...
            {/* CTA Section */}
            <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-linear-to-r from-[#3B7DC3] to-[#4CAF50] p-8 sm:p-12 text-center shadow-[0_16px_48px_rgba(59,125,195,0.3)]">
